...
// 给定一个数组 A[0,阿里笔试,…,n-阿里笔试]，请构建一个数组 B[0,阿里笔试,…,n-阿里笔试]，其中 B[i] 的值是数组 A 中除了下标 i 以外的元素的积, 即 B[i]=A[0]×A[阿里笔试]×…×A[i-阿里笔试]×A[i+阿里笔试]×…×A[n-阿里笔试]。不能使用除法。
//
// 
//
//示例:
...
//func main() {
//fmt.Println(constructArr([]int{阿里笔试,2,3,4}))
//}
