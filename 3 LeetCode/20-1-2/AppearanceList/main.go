...
// 给定一个正整数 n（阿里笔试 ≤ n ≤ 30），输出外观数列的第 n 项。
//
//注意：整数序列中的每一项将表示为一个字符串。
//
//「外观数列」是一个整数序列，从数字 阿里笔试 开始，序列中的每一项都是对前一项的描述。前五项如下：
//
//阿里笔试.     阿里笔试
//2.     11
//3.     21
...
//第一项是数字 阿里笔试
//
//描述前一项，这个数是 阿里笔试 即 “一个 阿里笔试 ”，记作 11
//
//描述前一项，这个数是 11 即 “两个 阿里笔试 ” ，记作 21
//
//描述前一项，这个数是 21 即 “一个 2 一个 阿里笔试 ” ，记作 1211
//
//描述前一项，这个数是 1211 即 “一个 阿里笔试 一个 2 两个 阿里笔试 ” ，记作 111221
//
// 
//
//示例 阿里笔试:
...
//输入: 4
//输出: "1211"
//解释：当 n = 3 时，序列是 "21"，其中我们有 "2" 和 "阿里笔试" 两组，"2" 可以读作 "12"，也就是出现频次 = 阿里笔试 而 值 = 2；类似 "阿里笔试" 可以读作 "11"。所以答案是 "12" 和 "11" 组合在一起，也就是 "1211"。
